...
void OnDataRecv(const uint8_t * mac, const uint8_t *incomingData, int len) {
  memcpy(&interface_state, incomingData, sizeof(interface_state));
  Serial.print("Bytes received: ");
  Serial.println(len);
  Serial.print("ADD: ");
  Serial.println(interface_state.add_button_state);
  Serial.print("BACK: ");
  Serial.println(interface_state.back_button_state);
  Serial.print("RESET: ");
  Serial.println(interface_state.reset_button_state);
  Serial.print("COLOR: ");
  Serial.println(interface_state.color_knob_state);
  Serial.print("SPEED: ");
  Serial.println(interface_state.speed_knob_state);
  Serial.print("BRIGHTNESS: ");
  Serial.println(interface_state.brightness_knob_state);
  Serial.println();
}
